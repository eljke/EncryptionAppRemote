        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/home",
                                "/register", "/login", "/logout", "/change-password", "/oauth/**", "/actuator/info/**", "/actuator/health/**",
                                "/encryption/**", "/api/**",
                                "/static/**", "/template/**", "/css/**", "/js/**", "/script/**", "/style/**", "/videos/**", "/images/**",
                                "/swagger-ui/**", "/v3/api-docs/**").permitAll()
                        .requestMatchers("/user/**").hasAnyAuthority("ADMIN")
                        .requestMatchers("/admin/**").hasAnyAuthority("ADMIN")
                        .requestMatchers("/actuator/env/**", "/actuator/beans/**", "/actuator/heapdump/**",
                                "/actuator/loggers/**", "/actuator/metrics/**", "/actuator/prometheus/**").hasAnyAuthority("ADMIN")
